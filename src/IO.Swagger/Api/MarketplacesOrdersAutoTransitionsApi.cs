...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IMarketplacesOrdersAutoTransitionsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class MarketplacesOrdersAutoTransitionsApi : IMarketplacesOrdersAutoTransitionsApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="MarketplacesOrdersAutoTransitionsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public MarketplacesOrdersAutoTransitionsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public MarketplacesOrdersAutoTransitionsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> ConfigureAutomaticTransitionsWithHttpInfo (ConfigureAutomaticTransitionRequest request)
        {
            ...
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling MarketplacesOrdersAutoTransitionsApi->ConfigureAutomaticTransitions");
