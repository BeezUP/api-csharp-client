...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IUserLOVApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class UserLOVApi : IUserLOVApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="UserLOVApi"/> class.
        /// </summary>
        /// <returns></returns>
        public UserLOVApi(String basePath)
        {
        ...
        /// <returns></returns>
        public UserLOVApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< List<BeezUPCommonLOVLink2> > GetUserListGroupWithHttpInfo (string listGroupName)
        {
            ...
            if (listGroupName == null)
                throw new ApiException(400, "Missing required parameter 'listGroupName' when calling UserLOVApi->GetUserListGroup");
        ...
        public ApiResponse< List<BeezUPCommonListOfValueItem> > GetUserListOfValuesWithHttpInfo (string listName, List<string> acceptLanguage = null)
        {
            ...
            if (listName == null)
                throw new ApiException(400, "Missing required parameter 'listName' when calling UserLOVApi->GetUserListOfValues");
