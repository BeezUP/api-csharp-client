...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IMarketplacesOrdersExportsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class MarketplacesOrdersExportsApi : IMarketplacesOrdersExportsApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="MarketplacesOrdersExportsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public MarketplacesOrdersExportsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public MarketplacesOrdersExportsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> ExportOrdersWithHttpInfo (ExportOrderListRequest request)
        {
            ...
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling MarketplacesOrdersExportsApi->ExportOrders");
        ...
        public ApiResponse< OrderExportations > GetOrderExportationsWithHttpInfo (int? pageNumber, int? pageSize, string storeId)
        {
            ...
            if (pageNumber == null)
                throw new ApiException(400, "Missing required parameter 'pageNumber' when calling MarketplacesOrdersExportsApi->GetOrderExportations");
            // verify the required parameter 'pageSize' is set
            if (pageSize == null)
                throw new ApiException(400, "Missing required parameter 'pageSize' when calling MarketplacesOrdersExportsApi->GetOrderExportations");
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling MarketplacesOrdersExportsApi->GetOrderExportations");
