...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IPublicSecuritySecurityApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PublicSecuritySecurityApi : IPublicSecuritySecurityApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PublicSecuritySecurityApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PublicSecuritySecurityApi(String basePath)
        {
        ...
        /// <returns></returns>
        public PublicSecuritySecurityApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< ApiCredentials > LoginWithHttpInfo (LoginRequest request)
        {
            ...
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling PublicSecuritySecurityApi->Login");
        ...
        public ApiResponse<Object> LostPasswordWithHttpInfo (BeezUPCommonEmail email)
        {
            ...
            if (email == null)
                throw new ApiException(400, "Missing required parameter 'email' when calling PublicSecuritySecurityApi->LostPassword");
        ...
        public ApiResponse<Object> RegisterWithHttpInfo (RegisterRequest request)
        {
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling PublicSecuritySecurityApi->Register");
