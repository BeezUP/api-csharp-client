...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IV2UserChannelsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class V2UserChannelsApi : IV2UserChannelsApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="V2UserChannelsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public V2UserChannelsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public V2UserChannelsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< ChannelRootCategory > GetChannelCategoriesWithHttpInfo (string channelId, List<string> acceptEncoding)
        {
            ...
            if (channelId == null)
                throw new ApiException(400, "Missing required parameter 'channelId' when calling V2UserChannelsApi->GetChannelCategories");
            // verify the required parameter 'acceptEncoding' is set
            if (acceptEncoding == null)
                throw new ApiException(400, "Missing required parameter 'acceptEncoding' when calling V2UserChannelsApi->GetChannelCategories");
        ...
        public ApiResponse< List<ChannelColumn> > GetChannelColumnsWithHttpInfo (string channelId, List<string> acceptEncoding, List<BeezUPCommonChannelColumnId> request = null)
        {
            // verify the required parameter 'channelId' is set
            if (channelId == null)
                throw new ApiException(400, "Missing required parameter 'channelId' when calling V2UserChannelsApi->GetChannelColumns");
            // verify the required parameter 'acceptEncoding' is set
            if (acceptEncoding == null)
                throw new ApiException(400, "Missing required parameter 'acceptEncoding' when calling V2UserChannelsApi->GetChannelColumns");
        ...
        public ApiResponse< ChannelInfo > GetChannelInfoWithHttpInfo (string channelId)
        {
            // verify the required parameter 'channelId' is set
            if (channelId == null)
                throw new ApiException(400, "Missing required parameter 'channelId' when calling V2UserChannelsApi->GetChannelInfo");
        ...
        public ApiResponse< List<ChannelHeader> > GetCurrentChannelsWithHttpInfo (string storeId)
        {
            ...
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling V2UserChannelsApi->GetCurrentChannels");
