...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface ICustomerFriendsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CustomerFriendsApi : ICustomerFriendsApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerFriendsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CustomerFriendsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CustomerFriendsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< UserFriendInfo > GetFriendInfoWithHttpInfo (string userId)
        {
            ...
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling CustomerFriendsApi->GetFriendInfo");
