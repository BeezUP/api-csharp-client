...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IAnalyticsTrackingApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AnalyticsTrackingApi : IAnalyticsTrackingApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AnalyticsTrackingApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AnalyticsTrackingApi(String basePath)
        {
        ...
        /// <returns></returns>
        public AnalyticsTrackingApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< TrackedClicks > GetStoreTrackedClicksWithHttpInfo (string storeId, int? count = null)
        {
            ...
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling AnalyticsTrackingApi->GetStoreTrackedClicks");
        ...
        public ApiResponse< TrackedExternalOrders > GetStoreTrackedExternalOrdersWithHttpInfo (string storeId, int? count = null)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling AnalyticsTrackingApi->GetStoreTrackedExternalOrders");
        ...
        public ApiResponse< TrackedOrders > GetStoreTrackedOrdersWithHttpInfo (string storeId, int? count = null)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling AnalyticsTrackingApi->GetStoreTrackedOrders");
        ...
        public ApiResponse< StoreTrackingStatus > GetStoreTrackingStatusWithHttpInfo (string storeId)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling AnalyticsTrackingApi->GetStoreTrackingStatus");
