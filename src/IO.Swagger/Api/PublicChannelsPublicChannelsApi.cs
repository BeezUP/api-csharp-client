...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IPublicChannelsPublicChannelsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PublicChannelsPublicChannelsApi : IPublicChannelsPublicChannelsApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PublicChannelsPublicChannelsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PublicChannelsPublicChannelsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public PublicChannelsPublicChannelsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< ChannelInfoList > GetChannelsWithHttpInfo (string countryIsoCode, List<string> acceptEncoding)
        {
            ...
            if (countryIsoCode == null)
                throw new ApiException(400, "Missing required parameter 'countryIsoCode' when calling PublicChannelsPublicChannelsApi->GetChannels");
            // verify the required parameter 'acceptEncoding' is set
            if (acceptEncoding == null)
                throw new ApiException(400, "Missing required parameter 'acceptEncoding' when calling PublicChannelsPublicChannelsApi->GetChannels");
