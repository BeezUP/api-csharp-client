...
namespace IO.Swagger.Api
{
    ...
    public interface IPublicChannelsApi : IApiAccessor
    {
        ...
        ApiResponse<Dictionary<string, string>> GetChannelsByCountryWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<Dictionary<string, string>> GetChannelsByCountryAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<Dictionary<string, string>>> GetChannelsByCountryAsyncWithHttpInfo ();
    ...
    public partial class PublicChannelsApi : IPublicChannelsApi
    {
        ...
        public ApiResponse< ChannelInfoList > GetChannelsWithHttpInfo (string countryIsoCode, List<string> acceptEncoding)
        {
            ...
            var localVarPath = "/BeezUP/public_channels/2.0/{countryIsoCode}";
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Dictionary&lt;string, string&gt;</returns>
        public Dictionary<string, string> GetChannelsByCountry ()
        {
             ApiResponse<Dictionary<string, string>> localVarResponse = GetChannelsByCountryWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Dictionary&lt;string, string&gt;</returns>
        public ApiResponse< Dictionary<string, string> > GetChannelsByCountryWithHttpInfo ()
        {

            var localVarPath = "/BeezUP/public_channels/2.0/";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetChannelsByCountry", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of Dictionary&lt;string, string&gt;</returns>
        public async System.Threading.Tasks.Task<Dictionary<string, string>> GetChannelsByCountryAsync ()
        {
             ApiResponse<Dictionary<string, string>> localVarResponse = await GetChannelsByCountryAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, string&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Dictionary<string, string>>> GetChannelsByCountryAsyncWithHttpInfo ()
        {
