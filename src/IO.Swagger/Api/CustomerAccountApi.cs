...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface ICustomerAccountApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CustomerAccountApi : ICustomerAccountApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerAccountApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CustomerAccountApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CustomerAccountApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> ActivateUserAccountWithHttpInfo (string emailActivationId)
        {
            ...
            if (emailActivationId == null)
                throw new ApiException(400, "Missing required parameter 'emailActivationId' when calling CustomerAccountApi->ActivateUserAccount");
        ...
        public ApiResponse<Object> ChangePasswordWithHttpInfo (ChangePasswordRequest request)
        {
            ...
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling CustomerAccountApi->ChangePassword");
        ...
        public ApiResponse<Object> SaveCompanyInfoWithHttpInfo (CompanyInfo request)
        {
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling CustomerAccountApi->SaveCompanyInfo");
        ...
        public ApiResponse<Object> SaveCreditCardInfoWithHttpInfo (CreditCardInfo request)
        {
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling CustomerAccountApi->SaveCreditCardInfo");
        ...
        public ApiResponse<Object> SavePersonalInfoWithHttpInfo (PersonalInfo request)
        {
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling CustomerAccountApi->SavePersonalInfo");
        ...
        public ApiResponse<Object> SaveProfilePictureInfoWithHttpInfo (ProfilePictureInfo request)
        {
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling CustomerAccountApi->SaveProfilePictureInfo");
