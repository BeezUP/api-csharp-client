...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IMarketplacesOrdersListApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class MarketplacesOrdersListApi : IMarketplacesOrdersListApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="MarketplacesOrdersListApi"/> class.
        /// </summary>
        /// <returns></returns>
        public MarketplacesOrdersListApi(String basePath)
        {
        ...
        /// <returns></returns>
        public MarketplacesOrdersListApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< OrderListLight > GetOrderListLightWithHttpInfo (OrderListRequest request)
        {
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling MarketplacesOrdersListApi->GetOrderListLight");
