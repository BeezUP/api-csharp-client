...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface ICustomerStoresApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CustomerStoresApi : ICustomerStoresApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerStoresApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CustomerStoresApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CustomerStoresApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< LinksGetStoresLink > CreateStoreWithHttpInfo (CreateStoreRequest request)
        {
            ...
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling CustomerStoresApi->CreateStore");
        ...
        public ApiResponse<Object> DeleteStoreWithHttpInfo (string storeId)
        {
            ...
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling CustomerStoresApi->DeleteStore");
        ...
        public ApiResponse< StoreHeader > GetStoreWithHttpInfo (string storeId)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling CustomerStoresApi->GetStore");
        ...
        public ApiResponse<Object> UpdateStoreWithHttpInfo (string storeId, UpdateStoreRequest request)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling CustomerStoresApi->UpdateStore");
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling CustomerStoresApi->UpdateStore");
