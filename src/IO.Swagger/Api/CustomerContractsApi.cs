...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface ICustomerContractsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CustomerContractsApi : ICustomerContractsApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerContractsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CustomerContractsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CustomerContractsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< BeezUPCommonInfoSummaries > CreateContractWithHttpInfo (CreateContract request)
        {
            ...
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling CustomerContractsApi->CreateContract");
        ...
        public ApiResponse< Offer > GetOfferWithHttpInfo (OfferRequest request)
        {
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling CustomerContractsApi->GetOffer");
        ...
        public ApiResponse<Object> TerminateCurrentContractWithHttpInfo (TerminateContract request)
        {
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling CustomerContractsApi->TerminateCurrentContract");
