...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NextContractInfo :  IEquatable<NextContractInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NextContractInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NextContractInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NextContractInfo" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NextContractInfo);
        }

        /// <summary>
        /// Returns true if NextContractInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of NextContractInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NextContractInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
