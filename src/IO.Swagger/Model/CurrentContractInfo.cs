...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CurrentContractInfo :  IEquatable<CurrentContractInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentContractInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CurrentContractInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentContractInfo" /> class.
        /// </summary>
        ...
        public CurrentContractInfo(int? TrialPeriodInMonth = default(int?), double? BillingPeriodPercentDiscount = default(double?), int? DiscountDurationInMonth = default(int?), double? PercentDiscount = default(double?), OfferId OfferId = default(OfferId), StoreCount StoreCount = default(StoreCount), DateTime? StartUtcDate = default(DateTime?), DateTime? CommitmentCalculatedFinishUtcDate = default(DateTime?), int? BillingPeriodInMonth = default(int?), double? FixedPrice = default(double?), string OfferName = default(string), BeezUPCommonCurrencyCode CurrencyCode = default(BeezUPCommonCurrencyCode), ContractId ContractId = default(ContractId), int? CommitmentPeriodInMonth = default(int?), int? ClickIncluded = default(int?), double? AdditionalClickPrice = default(double?), string IpUserCreation = default(string), string IpUserModification = default(string), FixedAndVariableClickModelInfo FixedAndVariableClickInfo = default(FixedAndVariableClickModelInfo), VariableModelInfo VariableModelInfo = default(VariableModelInfo), bool? IsCommitmentRenewalAutomatically = default(bool?), DateTime? DiscountEndUtcDate = default(DateTime?), bool? IsModifiableContract = default(bool?), CurrentContractInfoLinks Links = default(CurrentContractInfoLinks))
        {
            // to ensure "Links" is required (not null)
            if (Links == null)
            {
                throw new InvalidDataException("Links is a required property for CurrentContractInfo and cannot be null");
            }
            else
            {
                this.Links = Links;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CurrentContractInfo);
        }

        /// <summary>
        /// Returns true if CurrentContractInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of CurrentContractInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurrentContractInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
