...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderExportationsLinks :  IEquatable<OrderExportationsLinks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderExportationsLinks" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderExportationsLinks() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderExportationsLinks" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OrderExportationsLinks);
        }

        /// <summary>
        /// Returns true if OrderExportationsLinks instances are equal
        /// </summary>
        /// <param name="other">Instance of OrderExportationsLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderExportationsLinks other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
