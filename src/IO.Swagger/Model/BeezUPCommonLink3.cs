...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BeezUPCommonLink3 :  IEquatable<BeezUPCommonLink3>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BeezUPCommonLink3" /> class.
        /// </summary>
        ...
        public BeezUPCommonLink3(string Description = default(string), BeezUPCommonHref Href = default(BeezUPCommonHref), BeezUPCommonOperationId OperationId = default(BeezUPCommonOperationId), BeezUPCommonHttpMethod Method = default(BeezUPCommonHttpMethod), Dictionary<string, BeezUPCommonLinkParameter3> Parameters = default(Dictionary<string, BeezUPCommonLinkParameter3>), bool? Templated = default(bool?), BeezUPCommonInfoSummaries Info = default(BeezUPCommonInfoSummaries))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BeezUPCommonLink3);
        }

        /// <summary>
        /// Returns true if BeezUPCommonLink3 instances are equal
        /// </summary>
        /// <param name="other">Instance of BeezUPCommonLink3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BeezUPCommonLink3 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
