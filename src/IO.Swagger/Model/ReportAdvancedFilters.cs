...
namespace IO.Swagger.Model
{
    ...
    public partial class ReportAdvancedFilters :  IEquatable<ReportAdvancedFilters>, IValidatableObject
    {
        ...
        /// <param name="OnlyPaymentValidatedOrders">If true, you will get the only the orders with payment validated. Otherwise, you will get all orders validated or not. (required).</param>
        /// <param name="OnlyDirectSales">If true, you will get only direct sales. Otherwise the indirect sales will be included. (required).</param>
        /// <param name="PerformanceIndicatorFormula">PerformanceIndicatorFormula (required).</param>
        public ReportAdvancedFilters(MargingType MargingType = default(MargingType), int? GlobalMarginPercent = default(int?), LinkClickToOrderType LinkClickToOrderType = default(LinkClickToOrderType), int? LinkClickToOrderMaxDay = default(int?), bool? OnlyPaymentValidatedOrders = default(bool?), bool? OnlyDirectSales = default(bool?), PerformanceIndicatorFormula PerformanceIndicatorFormula = default(PerformanceIndicatorFormula))
        {
