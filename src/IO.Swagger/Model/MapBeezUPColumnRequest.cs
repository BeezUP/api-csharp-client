...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MapBeezUPColumnRequest :  IEquatable<MapBeezUPColumnRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MapBeezUPColumnRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MapBeezUPColumnRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MapBeezUPColumnRequest" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MapBeezUPColumnRequest);
        }

        /// <summary>
        /// Returns true if MapBeezUPColumnRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of MapBeezUPColumnRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MapBeezUPColumnRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
