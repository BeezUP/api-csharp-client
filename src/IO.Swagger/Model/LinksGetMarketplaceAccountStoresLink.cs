...
namespace IO.Swagger.Model
{
    ...
    public partial class LinksGetMarketplaceAccountStoresLink :  IEquatable<LinksGetMarketplaceAccountStoresLink>, IValidatableObject
    {
        ...
        protected LinksGetMarketplaceAccountStoresLink() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LinksGetMarketplaceAccountStoresLink" /> class.
        /// </summary>
        ...
        public LinksGetMarketplaceAccountStoresLink(string Label = default(string), BeezUPCommonDocUrl DocUrl = default(BeezUPCommonDocUrl), string Description = default(string), BeezUPCommonHref Href = default(BeezUPCommonHref), BeezUPCommonOperationId OperationId = default(BeezUPCommonOperationId), BeezUPCommonHttpMethod Method = default(BeezUPCommonHttpMethod), Dictionary<string, BeezUPCommonLinkParameter3> Parameters = default(Dictionary<string, BeezUPCommonLinkParameter3>), bool? UrlTemplated = default(bool?), bool? AllRequiredParamsProvided = default(bool?), bool? AllOptionalParamsProvided = default(bool?), BeezUPCommonInfoSummaries Info = default(BeezUPCommonInfoSummaries))
        {
            ...
            if (Href == null)
            {
                throw new InvalidDataException("Href is a required property for LinksGetMarketplaceAccountStoresLink and cannot be null");
            }
            else
            {
                this.Href = Href;
