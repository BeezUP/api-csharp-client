...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderIdentifierWithETag :  IEquatable<OrderIdentifierWithETag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderIdentifierWithETag" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderIdentifierWithETag() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderIdentifierWithETag" /> class.
        /// </summary>
        ...
        public OrderIdentifierWithETag(BeezUPCommonMarketplaceTechnicalCode MarketplaceTechnicalCode = default(BeezUPCommonMarketplaceTechnicalCode), AccountId AccountId = default(AccountId), BeezUPOrderId BeezUPOrderId = default(BeezUPOrderId), Etag Etag = default(Etag))
        {
            // to ensure "MarketplaceTechnicalCode" is required (not null)
            if (MarketplaceTechnicalCode == null)
            {
                throw new InvalidDataException("MarketplaceTechnicalCode is a required property for OrderIdentifierWithETag and cannot be null");
            }
            else
            {
            ...
            if (AccountId == null)
            {
                throw new InvalidDataException("AccountId is a required property for OrderIdentifierWithETag and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("BeezUPOrderId is a required property for OrderIdentifierWithETag and cannot be null");
            }
            else
            {
            ...
            if (Etag == null)
            {
                throw new InvalidDataException("Etag is a required property for OrderIdentifierWithETag and cannot be null");
            }
            else
            {
                this.Etag = Etag;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OrderIdentifierWithETag);
        }

        /// <summary>
        /// Returns true if OrderIdentifierWithETag instances are equal
        /// </summary>
        /// <param name="other">Instance of OrderIdentifierWithETag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderIdentifierWithETag other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
