...
namespace IO.Swagger.Model
{
    ...
    public partial class OrderIdentifierWithETag :  IEquatable<OrderIdentifierWithETag>, IValidatableObject
    {
        ...
        public OrderIdentifierWithETag(MarketplaceTechnicalCode MarketplaceTechnicalCode = default(MarketplaceTechnicalCode), AccountId AccountId = default(AccountId), BeezUPOrderId BeezUPOrderId = default(BeezUPOrderId), Etag Etag = default(Etag))
        {
