...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinksGetReportFiltersLink :  IEquatable<LinksGetReportFiltersLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinksGetReportFiltersLink" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LinksGetReportFiltersLink() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LinksGetReportFiltersLink" /> class.
        /// </summary>
        ...
        public LinksGetReportFiltersLink(BeezUPCommonDocUrl DocUrl = default(BeezUPCommonDocUrl), string Description = default(string), BeezUPCommonHref Href = default(BeezUPCommonHref), BeezUPCommonOperationId OperationId = default(BeezUPCommonOperationId), BeezUPCommonHttpMethod Method = default(BeezUPCommonHttpMethod), Dictionary<string, BeezUPCommonLinkParameter3> Parameters = default(Dictionary<string, BeezUPCommonLinkParameter3>), bool? Templated = default(bool?), BeezUPCommonInfoSummaries Info = default(BeezUPCommonInfoSummaries))
        {
            ...
            if (Href == null)
            {
                throw new InvalidDataException("Href is a required property for LinksGetReportFiltersLink and cannot be null");
            }
            else
            {
                this.Href = Href;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LinksGetReportFiltersLink);
        }

        /// <summary>
        /// Returns true if LinksGetReportFiltersLink instances are equal
        /// </summary>
        /// <param name="other">Instance of LinksGetReportFiltersLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinksGetReportFiltersLink other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
