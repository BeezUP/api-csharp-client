...
namespace IO.Swagger.Model
{
    ...
    public partial class SetMerchantOrderInfoListRequestItem :  IEquatable<SetMerchantOrderInfoListRequestItem>, IValidatableObject
    {
        ...
        public SetMerchantOrderInfoListRequestItem(BeezUPCommonMarketplaceTechnicalCode MarketplaceTechnicalCode = default(BeezUPCommonMarketplaceTechnicalCode), AccountId AccountId = default(AccountId), BeezUPOrderId BeezUPOrderId = default(BeezUPOrderId), OrderMerchantOrderId OrderMerchantOrderId = default(OrderMerchantOrderId))
        {
