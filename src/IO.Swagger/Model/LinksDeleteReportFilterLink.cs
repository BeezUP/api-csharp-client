...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinksDeleteReportFilterLink :  IEquatable<LinksDeleteReportFilterLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinksDeleteReportFilterLink" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LinksDeleteReportFilterLink() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LinksDeleteReportFilterLink" /> class.
        /// </summary>
        ...
        public LinksDeleteReportFilterLink(string Label = default(string), BeezUPCommonDocUrl DocUrl = default(BeezUPCommonDocUrl), string Description = default(string), BeezUPCommonHref Href = default(BeezUPCommonHref), BeezUPCommonOperationId OperationId = default(BeezUPCommonOperationId), BeezUPCommonHttpMethod Method = default(BeezUPCommonHttpMethod), Dictionary<string, BeezUPCommonLinkParameter3> Parameters = default(Dictionary<string, BeezUPCommonLinkParameter3>), bool? UrlTemplated = default(bool?), bool? AllRequiredParamsProvided = default(bool?), bool? AllOptionalParamsProvided = default(bool?), BeezUPCommonInfoSummaries Info = default(BeezUPCommonInfoSummaries))
        {
            ...
            if (Href == null)
            {
                throw new InvalidDataException("Href is a required property for LinksDeleteReportFilterLink and cannot be null");
            }
            else
            {
                this.Href = Href;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LinksDeleteReportFilterLink);
        }

        /// <summary>
        /// Returns true if LinksDeleteReportFilterLink instances are equal
        /// </summary>
        /// <param name="other">Instance of LinksDeleteReportFilterLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinksDeleteReportFilterLink other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
