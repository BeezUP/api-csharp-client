...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReportByProductResponseLinks :  IEquatable<ReportByProductResponseLinks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportByProductResponseLinks" /> class.
        /// </summary>
        /// <param name="EnableAllProducts">EnableAllProducts.</param>
        /// <param name="DisableAllProducts">DisableAllProducts.</param>
        public ReportByProductResponseLinks(LinksOptimiseLink EnableAllProducts = default(LinksOptimiseLink), LinksOptimiseLink DisableAllProducts = default(LinksOptimiseLink))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ReportByProductResponseLinks);
        }

        /// <summary>
        /// Returns true if ReportByProductResponseLinks instances are equal
        /// </summary>
        /// <param name="other">Instance of ReportByProductResponseLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportByProductResponseLinks other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
