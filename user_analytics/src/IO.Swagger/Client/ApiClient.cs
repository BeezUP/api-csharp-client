...
namespace IO.Swagger.Client
{
    ...
    public partial class ApiClient
    {
        ...
        /// with default configuration and base path (https://api.beezup.com/v2/user/analytics).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("https://api.beezup.com/v2/user/analytics");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.beezup.com/v2/user/analytics).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://api.beezup.com/v2/user/analytics")
        {
