...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinksGetPublicationsLink :  IEquatable<LinksGetPublicationsLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinksGetPublicationsLink" /> class.
        /// </summary>
        ...
        public LinksGetPublicationsLink(string Description = default(string), BeezUPCommonHref Href = default(BeezUPCommonHref), BeezUPCommonOperationId OperationId = default(BeezUPCommonOperationId), BeezUPCommonHttpMethod Method = default(BeezUPCommonHttpMethod), Dictionary<string, BeezUPCommonLinkParameter3> Parameters = default(Dictionary<string, BeezUPCommonLinkParameter3>), bool? Templated = default(bool?), BeezUPCommonInfoSummaries Info = default(BeezUPCommonInfoSummaries))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LinksGetPublicationsLink);
        }

        /// <summary>
        /// Returns true if LinksGetPublicationsLink instances are equal
        /// </summary>
        /// <param name="other">Instance of LinksGetPublicationsLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinksGetPublicationsLink other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
