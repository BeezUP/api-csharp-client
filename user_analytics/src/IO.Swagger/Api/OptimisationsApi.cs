...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IOptimisationsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class OptimisationsApi : IOptimisationsApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="OptimisationsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public OptimisationsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public OptimisationsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> OptimiseWithHttpInfo (string storeId, string actionName, OptimiseRequest request)
        {
            ...
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling OptimisationsApi->Optimise");
            // verify the required parameter 'actionName' is set
            if (actionName == null)
                throw new ApiException(400, "Missing required parameter 'actionName' when calling OptimisationsApi->Optimise");
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling OptimisationsApi->Optimise");

            var localVarPath = "/{storeId}/optimisations/{actionName}";
        ...
        public ApiResponse<Object> OptimiseByCategoryWithHttpInfo (string storeId, string catalogCategoryId, string actionName, List<string> request = null)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling OptimisationsApi->OptimiseByCategory");
            // verify the required parameter 'catalogCategoryId' is set
            if (catalogCategoryId == null)
                throw new ApiException(400, "Missing required parameter 'catalogCategoryId' when calling OptimisationsApi->OptimiseByCategory");
            // verify the required parameter 'actionName' is set
            if (actionName == null)
                throw new ApiException(400, "Missing required parameter 'actionName' when calling OptimisationsApi->OptimiseByCategory");

            var localVarPath = "/{storeId}/optimisations/bycategory/{catalogCategoryId}/{actionName}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse<Object> OptimiseByChannelWithHttpInfo (string storeId, string channelId, string actionName)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling OptimisationsApi->OptimiseByChannel");
            // verify the required parameter 'channelId' is set
            if (channelId == null)
                throw new ApiException(400, "Missing required parameter 'channelId' when calling OptimisationsApi->OptimiseByChannel");
            // verify the required parameter 'actionName' is set
            if (actionName == null)
                throw new ApiException(400, "Missing required parameter 'actionName' when calling OptimisationsApi->OptimiseByChannel");

            var localVarPath = "/{storeId}/optimisations/bychannel/{channelId}/{actionName}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse<Object> OptimiseByProductWithHttpInfo (string storeId, string productId, string actionName, List<string> request = null)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling OptimisationsApi->OptimiseByProduct");
            // verify the required parameter 'productId' is set
            if (productId == null)
                throw new ApiException(400, "Missing required parameter 'productId' when calling OptimisationsApi->OptimiseByProduct");
            // verify the required parameter 'actionName' is set
            if (actionName == null)
                throw new ApiException(400, "Missing required parameter 'actionName' when calling OptimisationsApi->OptimiseByProduct");

            var localVarPath = "/{storeId}/optimisations/byproduct/{productId}/{actionName}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
