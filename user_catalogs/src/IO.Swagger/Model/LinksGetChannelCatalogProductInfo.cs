...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinksGetChannelCatalogProductInfo :  IEquatable<LinksGetChannelCatalogProductInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LinksGetChannelCatalogProductInfo);
        }

        /// <summary>
        /// Returns true if LinksGetChannelCatalogProductInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of LinksGetChannelCatalogProductInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinksGetChannelCatalogProductInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
