...
namespace IO.Swagger.Model
{
    ...
    public partial class OrderListRequest :  IEquatable<OrderListRequest>, IValidatableObject
    {
        ...
        /// <param name="DateSearchType">DateSearchType.</param>
        /// <param name="BeginPeriodUtcDate">The begin period you want to make the search. The period MUST not be greater than 30 days. If null, the current date minus 30 days will be used..</param>
        /// <param name="EndPeriodUtcDate">The end period of you search. The period MUST not be greater than 30 days. If null the current date will be used..</param>
        ...
        public List<MarketplaceTechnicalCode> MarketplaceTechnicalCodes { get; set; }
        /// <summary>
        /// Gets or Sets MarketplaceBusinessCodes
        /// </summary>
        [DataMember(Name="marketplaceBusinessCodes", EmitDefaultValue=false)]
        public List<MarketplaceBusinessCode> MarketplaceBusinessCodes { get; set; }
        /// <summary>
        /// Account id list
        /// </summary>
        ...
        /// </summary>
        /// <value>The begin period you want to make the search. The period MUST not be greater than 30 days. If null, the current date minus 30 days will be used.</value>
        ...
        /// </summary>
        /// <value>The end period of you search. The period MUST not be greater than 30 days. If null the current date will be used.</value>
