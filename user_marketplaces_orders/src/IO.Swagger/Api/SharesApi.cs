...
namespace IO.Swagger.Api
{
    ...
    public partial class SharesApi : ISharesApi
    {
        ...
        public ApiResponse<Object> DeleteShareWithHttpInfo (string storeId, string userId)
        {
            ...
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling SharesApi->DeleteShare");
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling SharesApi->DeleteShare");

            var localVarPath = "/stores/{storeId}/shares/{userId}";
        ...
        public ApiResponse< StoreShares > GetSharesWithHttpInfo (string storeId)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling SharesApi->GetShares");

            var localVarPath = "/stores/{storeId}/shares";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse<Object> ShareWithHttpInfo (string storeId, FriendEmail email)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling SharesApi->Share");
            // verify the required parameter 'email' is set
            if (email == null)
                throw new ApiException(400, "Missing required parameter 'email' when calling SharesApi->Share");
