...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BeezUPCommonCatalogColumnUserName :  IEquatable<BeezUPCommonCatalogColumnUserName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BeezUPCommonCatalogColumnUserName" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public BeezUPCommonCatalogColumnUserName()
        {
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BeezUPCommonCatalogColumnUserName);
        }

        /// <summary>
        /// Returns true if BeezUPCommonCatalogColumnUserName instances are equal
        /// </summary>
        /// <param name="other">Instance of BeezUPCommonCatalogColumnUserName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BeezUPCommonCatalogColumnUserName other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
