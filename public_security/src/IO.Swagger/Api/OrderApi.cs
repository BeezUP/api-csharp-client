    ...
    public partial class OrderApi : IOrderApi
    {
        ...
        public ApiResponse<Object> ChangeOrderWithHttpInfo (string marketplaceTechnicalCode, int? accountId, Guid? beezUPOrderId, string changeOrderType, string userName, ChangeOrderRequest request, string ifMatch, bool? testMode = null)
        {
            ...
            if (marketplaceTechnicalCode == null)
                throw new ApiException(400, "Missing required parameter 'marketplaceTechnicalCode' when calling OrderApi->ChangeOrder");
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new ApiException(400, "Missing required parameter 'accountId' when calling OrderApi->ChangeOrder");
            // verify the required parameter 'beezUPOrderId' is set
            if (beezUPOrderId == null)
                throw new ApiException(400, "Missing required parameter 'beezUPOrderId' when calling OrderApi->ChangeOrder");
            // verify the required parameter 'changeOrderType' is set
            if (changeOrderType == null)
                throw new ApiException(400, "Missing required parameter 'changeOrderType' when calling OrderApi->ChangeOrder");
            // verify the required parameter 'userName' is set
            if (userName == null)
                throw new ApiException(400, "Missing required parameter 'userName' when calling OrderApi->ChangeOrder");
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling OrderApi->ChangeOrder");
            // verify the required parameter 'ifMatch' is set
            if (ifMatch == null)
                throw new ApiException(400, "Missing required parameter 'ifMatch' when calling OrderApi->ChangeOrder");

            var localVarPath = "/{marketplaceTechnicalCode}/{accountId}/{beezUPOrderId}/{changeOrderType}";
        ...
        public ApiResponse<Object> ClearMerchantOrderInfoWithHttpInfo (string marketplaceTechnicalCode, int? accountId, Guid? beezUPOrderId)
        {
            // verify the required parameter 'marketplaceTechnicalCode' is set
            if (marketplaceTechnicalCode == null)
                throw new ApiException(400, "Missing required parameter 'marketplaceTechnicalCode' when calling OrderApi->ClearMerchantOrderInfo");
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new ApiException(400, "Missing required parameter 'accountId' when calling OrderApi->ClearMerchantOrderInfo");
            // verify the required parameter 'beezUPOrderId' is set
            if (beezUPOrderId == null)
                throw new ApiException(400, "Missing required parameter 'beezUPOrderId' when calling OrderApi->ClearMerchantOrderInfo");

            var localVarPath = "/{marketplaceTechnicalCode}/{accountId}/{beezUPOrderId}/clearMerchantOrderInfo";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< Order > GetOrderWithHttpInfo (string marketplaceTechnicalCode, int? accountId, Guid? beezUPOrderId, string ifNoneMatch = null)
        {
            // verify the required parameter 'marketplaceTechnicalCode' is set
            if (marketplaceTechnicalCode == null)
                throw new ApiException(400, "Missing required parameter 'marketplaceTechnicalCode' when calling OrderApi->GetOrder");
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new ApiException(400, "Missing required parameter 'accountId' when calling OrderApi->GetOrder");
            // verify the required parameter 'beezUPOrderId' is set
            if (beezUPOrderId == null)
                throw new ApiException(400, "Missing required parameter 'beezUPOrderId' when calling OrderApi->GetOrder");

            var localVarPath = "/{marketplaceTechnicalCode}/{accountId}/{beezUPOrderId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< OrderHistory > GetOrderHistoryWithHttpInfo (string marketplaceTechnicalCode, int? accountId, Guid? beezUPOrderId)
        {
            // verify the required parameter 'marketplaceTechnicalCode' is set
            if (marketplaceTechnicalCode == null)
                throw new ApiException(400, "Missing required parameter 'marketplaceTechnicalCode' when calling OrderApi->GetOrderHistory");
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new ApiException(400, "Missing required parameter 'accountId' when calling OrderApi->GetOrderHistory");
            // verify the required parameter 'beezUPOrderId' is set
            if (beezUPOrderId == null)
                throw new ApiException(400, "Missing required parameter 'beezUPOrderId' when calling OrderApi->GetOrderHistory");

            var localVarPath = "/{marketplaceTechnicalCode}/{accountId}/{beezUPOrderId}/history";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse<Object> HarvestOrderWithHttpInfo (string marketplaceTechnicalCode, int? accountId, Guid? beezUPOrderId)
        {
            // verify the required parameter 'marketplaceTechnicalCode' is set
            if (marketplaceTechnicalCode == null)
                throw new ApiException(400, "Missing required parameter 'marketplaceTechnicalCode' when calling OrderApi->HarvestOrder");
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new ApiException(400, "Missing required parameter 'accountId' when calling OrderApi->HarvestOrder");
            // verify the required parameter 'beezUPOrderId' is set
            if (beezUPOrderId == null)
                throw new ApiException(400, "Missing required parameter 'beezUPOrderId' when calling OrderApi->HarvestOrder");

            var localVarPath = "/{marketplaceTechnicalCode}/{accountId}/{beezUPOrderId}/harvest";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse<Object> SetMerchantOrderInfoWithHttpInfo (string marketplaceTechnicalCode, int? accountId, Guid? beezUPOrderId, SetMerchantOrderInfoRequest request)
        {
            // verify the required parameter 'marketplaceTechnicalCode' is set
            if (marketplaceTechnicalCode == null)
                throw new ApiException(400, "Missing required parameter 'marketplaceTechnicalCode' when calling OrderApi->SetMerchantOrderInfo");
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new ApiException(400, "Missing required parameter 'accountId' when calling OrderApi->SetMerchantOrderInfo");
            // verify the required parameter 'beezUPOrderId' is set
            if (beezUPOrderId == null)
                throw new ApiException(400, "Missing required parameter 'beezUPOrderId' when calling OrderApi->SetMerchantOrderInfo");
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling OrderApi->SetMerchantOrderInfo");

            var localVarPath = "/{marketplaceTechnicalCode}/{accountId}/{beezUPOrderId}/setMerchantOrderInfo";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
