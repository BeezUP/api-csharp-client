...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IAutoApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AutoApi : IAutoApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AutoApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AutoApi(String basePath)
        {
        ...
        /// <returns></returns>
        public AutoApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> AutoConfigureAutoImportIntervalWithHttpInfo (string storeId, ConfigureAutoImportIntervalRequest request)
        {
            ...
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling AutoApi->AutoConfigureAutoImportInterval");
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling AutoApi->AutoConfigureAutoImportInterval");

            var localVarPath = "/{storeId}/autoImport/scheduling/interval";
        ...
        public ApiResponse<Object> AutoDeleteAutoImportWithHttpInfo (string storeId)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling AutoApi->AutoDeleteAutoImport");

            var localVarPath = "/{storeId}/autoImport";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< AutoImportConfiguration > AutoGetAutoImportConfigurationWithHttpInfo (string storeId)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling AutoApi->AutoGetAutoImportConfiguration");
        ...
        public ApiResponse<Object> AutoPauseAutoImportWithHttpInfo (string storeId)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling AutoApi->AutoPauseAutoImport");

            var localVarPath = "/{storeId}/autoImport/pause";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse<Object> AutoResumeAutoImportWithHttpInfo (string storeId)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling AutoApi->AutoResumeAutoImport");

            var localVarPath = "/{storeId}/autoImport/resume";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse<Object> AutoScheduleAutoImportWithHttpInfo (string storeId, ScheduleAutoImportRequest request)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling AutoApi->AutoScheduleAutoImport");
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling AutoApi->AutoScheduleAutoImport");

            var localVarPath = "/{storeId}/autoImport/scheduling/schedules";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< List<BeezUPCommonLink2> > AutoStartAutoImportWithHttpInfo (string storeId)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling AutoApi->AutoStartAutoImport");

            var localVarPath = "/{storeId}/autoImport/start";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse<Object> ImportationActivateAutoImportWithHttpInfo (string storeId)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling AutoApi->ImportationActivateAutoImport");
