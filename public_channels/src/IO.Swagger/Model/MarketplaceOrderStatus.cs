...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MarketplaceOrderStatus :  IEquatable<MarketplaceOrderStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketplaceOrderStatus" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MarketplaceOrderStatus);
        }

        /// <summary>
        /// Returns true if MarketplaceOrderStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of MarketplaceOrderStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarketplaceOrderStatus other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
