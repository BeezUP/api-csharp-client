...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MarketplaceOrderId :  IEquatable<MarketplaceOrderId>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketplaceOrderId" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MarketplaceOrderId);
        }

        /// <summary>
        /// Returns true if MarketplaceOrderId instances are equal
        /// </summary>
        /// <param name="other">Instance of MarketplaceOrderId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarketplaceOrderId other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
