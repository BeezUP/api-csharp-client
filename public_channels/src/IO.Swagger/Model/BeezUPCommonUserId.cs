...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BeezUPCommonUserId :  IEquatable<BeezUPCommonUserId>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BeezUPCommonUserId" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public BeezUPCommonUserId()
        {
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BeezUPCommonUserId);
        }

        /// <summary>
        /// Returns true if BeezUPCommonUserId instances are equal
        /// </summary>
        /// <param name="other">Instance of BeezUPCommonUserId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BeezUPCommonUserId other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
