...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AvailableChannelLink :  IEquatable<AvailableChannelLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AvailableChannelLink" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AvailableChannelLink() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AvailableChannelLink" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AvailableChannelLink);
        }

        /// <summary>
        /// Returns true if AvailableChannelLink instances are equal
        /// </summary>
        /// <param name="other">Instance of AvailableChannelLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AvailableChannelLink other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
