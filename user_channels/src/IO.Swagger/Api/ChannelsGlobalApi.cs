...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IChannelsGlobalApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ChannelsGlobalApi : IChannelsGlobalApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelsGlobalApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ChannelsGlobalApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ChannelsGlobalApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< List<ChannelHeader> > GetAvailableChannelsWithHttpInfo (string storeId)
        {
            ...
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling ChannelsGlobalApi->GetAvailableChannels");
        ...
        public ApiResponse< ChannelRootCategory > GetChannelCategoriesWithHttpInfo (string channelId, List<string> acceptEncoding)
        {
            ...
            if (channelId == null)
                throw new ApiException(400, "Missing required parameter 'channelId' when calling ChannelsGlobalApi->GetChannelCategories");
            // verify the required parameter 'acceptEncoding' is set
            if (acceptEncoding == null)
                throw new ApiException(400, "Missing required parameter 'acceptEncoding' when calling ChannelsGlobalApi->GetChannelCategories");

            var localVarPath = "/{channelId}/categories";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< List<ChannelColumn> > GetChannelColumnsWithHttpInfo (string channelId, List<string> acceptEncoding, List<BeezUPCommonChannelColumnId> request = null)
        {
            // verify the required parameter 'channelId' is set
            if (channelId == null)
                throw new ApiException(400, "Missing required parameter 'channelId' when calling ChannelsGlobalApi->GetChannelColumns");
            // verify the required parameter 'acceptEncoding' is set
            if (acceptEncoding == null)
                throw new ApiException(400, "Missing required parameter 'acceptEncoding' when calling ChannelsGlobalApi->GetChannelColumns");

            var localVarPath = "/{channelId}/columns";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< ChannelInfo > GetChannelInfoWithHttpInfo (string channelId)
        {
            // verify the required parameter 'channelId' is set
            if (channelId == null)
                throw new ApiException(400, "Missing required parameter 'channelId' when calling ChannelsGlobalApi->GetChannelInfo");

            var localVarPath = "/{channelId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
