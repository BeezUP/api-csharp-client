...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinksSetChannelCatalogMarketplaceSettingsLink :  IEquatable<LinksSetChannelCatalogMarketplaceSettingsLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinksSetChannelCatalogMarketplaceSettingsLink" /> class.
        /// </summary>
        ...
        public LinksSetChannelCatalogMarketplaceSettingsLink(string Description = default(string), BeezUPCommonHref Href = default(BeezUPCommonHref), BeezUPCommonOperationId OperationId = default(BeezUPCommonOperationId), BeezUPCommonHttpMethod Method = default(BeezUPCommonHttpMethod), Dictionary<string, BeezUPCommonLinkParameter3> Parameters = default(Dictionary<string, BeezUPCommonLinkParameter3>), bool? Templated = default(bool?), BeezUPCommonInfoSummaries Info = default(BeezUPCommonInfoSummaries))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LinksSetChannelCatalogMarketplaceSettingsLink);
        }

        /// <summary>
        /// Returns true if LinksSetChannelCatalogMarketplaceSettingsLink instances are equal
        /// </summary>
        /// <param name="other">Instance of LinksSetChannelCatalogMarketplaceSettingsLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinksSetChannelCatalogMarketplaceSettingsLink other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
