...
namespace IO.Swagger.Api
{
    ...
    public partial class GroupsApi : IGroupsApi
    {
        ...
        public ApiResponse< List<BeezUPCommonLOVLink2> > GetPublicListGroupWithHttpInfo (string listGroupName)
        {
            ...
            var localVarPath = "/v2/public/lov/groups/{listGroupName}";
        ...
        public ApiResponse< List<BeezUPCommonLOVLink2> > GetPublicListGroupNamesWithHttpInfo ()
        {
            ...
            var localVarPath = "/v2/public/lov/groups";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< List<BeezUPCommonLOVLink2> > GetUserListGroupWithHttpInfo (string listGroupName)
        {
            // verify the required parameter 'listGroupName' is set
            if (listGroupName == null)
                throw new ApiException(400, "Missing required parameter 'listGroupName' when calling GroupsApi->GetUserListGroup");
