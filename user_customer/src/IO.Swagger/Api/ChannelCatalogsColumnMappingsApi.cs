...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IChannelCatalogsColumnMappingsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ChannelCatalogsColumnMappingsApi : IChannelCatalogsColumnMappingsApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelCatalogsColumnMappingsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ChannelCatalogsColumnMappingsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ChannelCatalogsColumnMappingsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> MapChannelCatalogColumnsWithHttpInfo (string channelCatalogId, ColumnMappingList request)
        {
            ...
            if (channelCatalogId == null)
                throw new ApiException(400, "Missing required parameter 'channelCatalogId' when calling ChannelCatalogsColumnMappingsApi->MapChannelCatalogColumns");
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling ChannelCatalogsColumnMappingsApi->MapChannelCatalogColumns");

            var localVarPath = "/{channelCatalogId}/columnMappings";
