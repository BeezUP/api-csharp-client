...
namespace IO.Swagger.Model
{
    ...
    public partial class OfferRequest :  IEquatable<OfferRequest>, IValidatableObject
    {
        ...
        public OfferRequest(OfferId OfferId = default(OfferId), StoreCount StoreCount = default(StoreCount), CouponDiscountCode CouponDiscountCode = default(CouponDiscountCode), CouponOfferCode CouponOfferCode = default(CouponOfferCode), BillingPeriodInMonth BillingPeriodInMonth = default(BillingPeriodInMonth))
        {
            // to ensure "OfferId" is required (not null)
            if (OfferId == null)
            {
                throw new InvalidDataException("OfferId is a required property for OfferRequest and cannot be null");
            }
            else
            {
            ...
            if (StoreCount == null)
            {
                throw new InvalidDataException("StoreCount is a required property for OfferRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("BillingPeriodInMonth is a required property for OfferRequest and cannot be null");
            }
            else
            {
