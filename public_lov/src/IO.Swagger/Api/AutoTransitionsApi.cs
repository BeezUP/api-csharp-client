...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IAutoTransitionsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AutoTransitionsApi : IAutoTransitionsApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AutoTransitionsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AutoTransitionsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public AutoTransitionsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> ConfigureAutomaticTransitionsWithHttpInfo (SaveAutomaticTransitionRequest request)
        {
            ...
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling AutoTransitionsApi->ConfigureAutomaticTransitions");

            var localVarPath = "/automaticTransitions";
