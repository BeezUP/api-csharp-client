...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IRightsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class RightsApi : IRightsApi
    {
        ...
        /// <returns></returns>
        public RightsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< List<FunctionalityRightInfo> > GetRightsWithHttpInfo (string storeId, List<string> functionalityCodeList)
        {
            ...
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling RightsApi->GetRights");
            // verify the required parameter 'functionalityCodeList' is set
            if (functionalityCodeList == null)
                throw new ApiException(400, "Missing required parameter 'functionalityCodeList' when calling RightsApi->GetRights");

            var localVarPath = "/stores/{storeId}/rights";
