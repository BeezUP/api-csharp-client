# IO.Swagger.Api.MarketplacesOrdersOrderApi
...
namespace Example
{
    public class ChangeOrderExample
    {
        public void main()
        {
            ...
            var apiInstance = new MarketplacesOrdersOrderApi();
            ...
            {
                Debug.Print("Exception when calling MarketplacesOrdersOrderApi.ChangeOrder: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class ClearMerchantOrderInfoExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling MarketplacesOrdersOrderApi.ClearMerchantOrderInfo: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetOrderExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling MarketplacesOrdersOrderApi.GetOrder: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetOrderHistoryExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling MarketplacesOrdersOrderApi.GetOrderHistory: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class HarvestOrderExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling MarketplacesOrdersOrderApi.HarvestOrder: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class SetMerchantOrderInfoExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling MarketplacesOrdersOrderApi.SetMerchantOrderInfo: " + e.Message );
            }
        }
    }
}
