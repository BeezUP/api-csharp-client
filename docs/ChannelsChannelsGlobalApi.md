# IO.Swagger.Api.ChannelsChannelsGlobalApi
...
namespace Example
{
    public class GetAvailableChannelsExample
    {
        public void main()
        {
            ...
            var apiInstance = new ChannelsChannelsGlobalApi();
            ...
            {
                Debug.Print("Exception when calling ChannelsChannelsGlobalApi.GetAvailableChannels: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetChannelCategoriesExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling ChannelsChannelsGlobalApi.GetChannelCategories: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetChannelColumnsExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling ChannelsChannelsGlobalApi.GetChannelColumns: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetChannelInfoExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling ChannelsChannelsGlobalApi.GetChannelInfo: " + e.Message );
            }
        }
    }
}
