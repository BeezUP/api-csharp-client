# IO.Swagger.Api.CustomerAlertsApi
...
namespace Example
{
    public class GetStoreAlertsExample
    {
        public void main()
        {
            ...
            var apiInstance = new CustomerAlertsApi();
            ...
            {
                Debug.Print("Exception when calling CustomerAlertsApi.GetStoreAlerts: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class SaveStoreAlertExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling CustomerAlertsApi.SaveStoreAlert: " + e.Message );
            }
        }
    }
}
