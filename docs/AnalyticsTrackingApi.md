# IO.Swagger.Api.AnalyticsTrackingApi
...
namespace Example
{
    public class GetStoreTrackedClicksExample
    {
        public void main()
        {
            ...
            var apiInstance = new AnalyticsTrackingApi();
            ...
            {
                Debug.Print("Exception when calling AnalyticsTrackingApi.GetStoreTrackedClicks: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetStoreTrackedExternalOrdersExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling AnalyticsTrackingApi.GetStoreTrackedExternalOrders: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetStoreTrackedOrdersExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling AnalyticsTrackingApi.GetStoreTrackedOrders: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetStoreTrackingStatusExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling AnalyticsTrackingApi.GetStoreTrackingStatus: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetTrackingStatusExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling AnalyticsTrackingApi.GetTrackingStatus: " + e.Message );
            }
        }
    }
}
